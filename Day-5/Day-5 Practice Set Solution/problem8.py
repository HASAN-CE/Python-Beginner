...
# If the language (values) are the same in the dictionary, it will display all the key-value pairs
# This is because for the update method, the identifiers are 'key'. If the key repeats, it updates the value.
